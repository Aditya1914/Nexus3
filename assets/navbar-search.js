...
class NavbarSearch extends HTMLElement {
  constructor() {
    ...
    // Set loading state to prevent FOUC
    this.wrapper.setAttribute('data-loading', 'true');
    
    // Initialize after a frame to prevent layout thrashing
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  navbarSearchElements.forEach(element => {
    if (!element.hasAttribute('data-initialized')) {
      ...
      // Set loading state and initialize after frame
